export type LocaleMessages = {
  ...
  PERSONAL_PROJECT_GITHUB_LABEL: string
  PERSONAL_PROJECT_LIVE_DEMO_LABEL: string
  PERSONAL_PROJECT_DEMO_LINK_0: string
  PERSONAL_PROJECT_TITLE_1: string
  PERSONAL_PROJECT_TEXT_1: string
  PERSONAL_PROJECT_LINK_LABEL_1: string
  PERSONAL_PROJECT_LINK_1: string
  TEXT_YEAR: string
  TEXT_MONTH: string
