...
const ko: Partial<LocaleMessages> = {
  ...
  BIO_TEXT_INTRO: `한국에서 3년 넘게 생활하고 있는 프랑스 출신 소프트웨어 엔지니어입니다. 2년간의 실무 경험에는 시니어 엔지니어들과 함께 일하며 탄탄한 기반을 다진 프랑스의 대형 IT 컨설팅 회사와, 더 큰 주도성과 자율성을 맡았던 한국의 스타트업이 포함됩니다. 저는 다양한 업무 환경과 기대에 빠르게 적응할 수 있습니다.`,
  ...
  BIO_TEXT_CONCLUSION: `소프트웨어를 단순히 작동시키는 것을 넘어, 기술 부채를 줄이고 신뢰성을 높이며 제품의 요구에 맞춰 확장할 수 있는 시스템을 구축하는 데 집중합니다. 최근 몇 년간에는 효율을 높이면서도 견고한 기술적 판단을 유지하고 장기적인 유지보수성과 코드 품질을 고려하기 위해 AI 기반 개발 도구를 워크플로에 통합했습니다.`,
