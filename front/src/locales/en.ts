...
const en: LocaleMessages = {
  ...
  BIO_TEXT_INTRO: `French software engineer living in South Korea for over 3 years. My 2 years of professional experience include a large IT consulting company in France, where I built a solid foundation working alongside senior engineers, and a startup in Korea, where I took on greater ownership and autonomy. I can adapt quickly to a variety of professional contexts and expectations.`,
  ...
  BIO_TEXT_BULLET_4:
    'AI Application: LangGraph, LangChain, RAG, Qdrant, LangSmith, Vertex AI (Gemini), Claude',
  BIO_TEXT_BULLET_5: 'Frontend: Vue.js, Vuex, Tailwind',
  BIO_TEXT_BULLET_6: 'Database: PostgreSQL',
  BIO_TEXT_CONCLUSION: `Beyond making software work, I focus on building systems that reduce technical debt, improve reliability, and scale with the needs of the product. In recent years, I also integrated AI-assisted development tools into my workflow to improve efficiency while maintaining strong technical judgment and remaining mindful of long-term maintainability and code quality.`,
